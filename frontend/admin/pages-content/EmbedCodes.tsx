...
const EmbedCodes = () => {
  ...
  // Use the actual current origin for the script tag
  const effectiveBaseUrl = typeof window !== 'undefined' ? window.location.origin : (process.env.NEXT_PUBLIC_API_URL || "https://soul-imaging-voice-agent.fly.dev");

  const code = `<script src="${effectiveBaseUrl}/orb/widget.js"
