...
export const DashboardHeader = ({ title }: Props) => {
  ...
  useEffect(() => {
    fetchNotifications();
    // Automatically refresh notifications every 30 seconds to keep the dashboard up-to-date
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={userDropdownRef}>
          <button
            ...
            className="w-9 h-9 rounded-full bg-secondary/50 border border-white/10 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary transition-all outline-none"
          >
