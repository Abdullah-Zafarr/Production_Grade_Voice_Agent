          ...
          <div className="glass-card p-6 animate-fade-in space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <input 
                ...
                className="bg-input border border-border/50 rounded-lg px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-accent"
              />
              <div className="flex items-center px-3 py-2 text-sm text-muted-foreground bg-muted/20 rounded-lg border border-border/50">
                Role: Admin
              </div>
              <button 
              ...
              <tbody>
                {members.map((m) => (
                  <tr key={m.id} className="border-b border-border/10 hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 rounded-full text-[10px] font-bold uppercase bg-primary/20 text-primary-foreground">
                        Admin
                      </span>
                    </td>
                    <td className="px-6 py-4">
